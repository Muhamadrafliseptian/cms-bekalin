...
<x-modal.modal-form id="createModal" title="Tambah Whats Inside" action="{{ route('home.whats-inside.store') }}">
...
@section('content')
    <div class="section-header">
        <h1>Whats Inside</h1>
        <x-breadcrumb :items="[['title' => 'Dashboard', 'url' => route('dashboard.index')], ['title' => 'Whats Inside']]" />
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header">
                        <h4>Form Whats Inside</h4>
                    </div>
                    <div class="card-body">
                        <form method="POST" enctype="multipart/form-data"
                            action="{{ route('master.section-contents.store', ['id' => 6]) }}">
                            @csrf
                            @php
                ...
                <div class="card">
                    <div class="card-header">
                        <div class="d-flex justify-content-between align-items-center w-100">
                            <h4 class="mb-0">Whats Inside Data</h4>
                            <x-table.add-button label="Tambah Data Whats Inside +" target="#createModal" />
                        </div>
                    </div>
                    <div class="card-body">
                        @php
                            ...
                            $rows = $data
                                ->map(function ($item) {
                                    return [
                                        ...
                                        'edit_url' => route('home.whats-inside.put', $item->id),
                                        'delete_url' => route('home.whats-inside.destroy', $item->id),
                                        'edit_data' => [
                                            'headline' => $item->headline,
